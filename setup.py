...
setup(name='tablesalt',
      ...
      package_data={
          'resources': [
              ...
              'networktopodk/DKrail/railways/*.shp',
              'networktopodk/DKrail/railways/*.prj',
              'networktopodk/DKrail/railways/*.shx',
              'networktopodk/DKrail/railways/*.sbx',
              'networktopodk/DKrail/railways/*.sbn',
              'networktopodk/DKrail/railways/*.cpg',
              'networktopodk/DKrail/railways/*.dbf',
