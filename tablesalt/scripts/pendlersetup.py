...
+----------------------------------+----------------+----------------------+---------------------------------+----------+
|          EncryptedCardEngravedID |   SeasonPassID | SeasonPassTemplateID | SeasonPassName                  | Fareset  |
+==================================+================+======================+=================================+==========+
| 42454135373736374541303030343937 |        2120462 |              8192163 | DOT Pendler Kombi m. Metro      | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+
| 32433241303531383137334546443541 |        2097861 |              8192130 | Udgået - Pendler Kombi Sjælland | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+
| 32433241303531383137334546443541 |        2105617 |              8192130 | Udgået - Pendler Kombi Sjælland | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+
| 32433241303531383137334546443541 |        2113630 |              8192130 | Udgået - Pendler Kombi Sjælland | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+
| 32433241303531383137334546443541 |        2125274 |              8192163 | DOT Pendler Kombi m. Metro      | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+
| 32433241303531383137334546443541 |        2133790 |              8192163 | DOT Pendler Kombi m. Metro      | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+
| 32433241303531383137334546443541 |        2141567 |              8192163 | DOT Pendler Kombi m. Metro      | Sjælland |
+----------------------------------+----------------+----------------------+---------------------------------+----------+

...

+----------------+------------------+---------------------+------------------------------------------------------+
| PsedoFareset   | SeasonPassType   | PassengerGroupType1 | SeasonPassStatus                                     |
+================+==================+=====================+======================================================+
| Hovedstaden    | NumberOfZones    |                   1 | Slettet, periodekort er allerede fjernet fra kortet. |
+----------------+------------------+---------------------+------------------------------------------------------+
| Hovedstaden    | NumberOfZones    |                   1 | Slettet, periodekort er allerede fjernet fra kortet. |
+----------------+------------------+---------------------+------------------------------------------------------+
| Hovedstaden    | NumberOfZones    |                   1 | Slettet, periodekort er allerede fjernet fra kortet. |
...
| Hovedstaden    | NumberOfZones    |                   1 | Slettet, periodekort er allerede fjernet fra kortet. |
+----------------+------------------+---------------------+------------------------------------------------------+
| Hovedstaden    | NumberOfZones    |                   1 | Stoppet, periodekort kan fjernes fra kortet          |
+----------------+------------------+---------------------+------------------------------------------------------+
| Hovedstaden    | NumberOfZones    |                   1 | Slettet, periodekort er allerede fjernet fra kortet. |
+----------------+------------------+---------------------+------------------------------------------------------+
| Hovedstaden    | NumberOfZones    |                   1 | Stoppet, periodekort kan fjernes fra kortet          |
...
+-------------------+-----------------+-------------+--------------+------------+
| ValidityStartDT   | ValidityEndDT   |   ValidDays |   FromZoneNr |   ToZoneNr |
+===================+=================+=============+==============+============+
| 03/09/2019        | 16/09/2019      |          14 |         1002 |       1052 |
+-------------------+-----------------+-------------+--------------+------------+
| 05/06/2019        | 04/07/2019      |          30 |         1001 |       1085 |
+-------------------+-----------------+-------------+--------------+------------+
| 05/07/2019        | 03/08/2019      |          30 |         1001 |       1085 |
+-------------------+-----------------+-------------+--------------+------------+
| 05/08/2019        | 03/09/2019      |          30 |         1001 |       1085 |
+-------------------+-----------------+-------------+--------------+------------+
| 12/09/2019        | 11/10/2019      |          30 |         1001 |       1085 |
+-------------------+-----------------+-------------+--------------+------------+
| 22/10/2019        | 20/11/2019      |          30 |         1001 |       1085 |
+-------------------+-----------------+-------------+--------------+------------+
| 21/11/2019        | 20/12/2019      |          30 |         1001 |       1085 |
+-------------------+-----------------+-------------+--------------+------------+
...

+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
| SeasonPassZones | PassagerType | TpurseRequired | SeasonPassCategory  | Pris     | RefundType                | productdate  |
+=================+==============+================+=====================+==========+===========================+==============+
|               5 | Voksen       | Yes            | Standard            | 623,26   | TILBAGEBETALING REJSEKORT | 03/09/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
|               8 | Voksen       | Yes            | Standard            | 1.329,90 | nan                       | 05/06/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
|               8 | Voksen       | Yes            | Standard            | 1.329,90 | nan                       | 05/07/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
|               8 | Voksen       | Yes            | Standard            | 1.329,90 | nan                       | 05/08/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
|               8 | Voksen       | Yes            | Standard            | 1.329,90 | nan                       | 12/09/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
|               8 | Voksen       | Yes            | Standard            | 1.329,90 | nan                       | 22/10/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
|               8 | Voksen       | Yes            | Standard            | 1.329,90 | nan                       | 21/11/2019   |
+-----------------+--------------+----------------+---------------------+----------+---------------------------+--------------+
