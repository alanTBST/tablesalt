...
def main(ticket_length, ticket, year, model, rabat_level):


    tripkeys = _load_single_tripkeys(year, rabat_level, model)
    ticket_tripkeys = tripkeys[ticket_length][ticket]
    ...
    merged = _merge_data_results(stop_data, res)
    ...
    merged = merged.loc[merged.loc[:, 'shares'].notnull()]
...
if __name__ == "__main__":
    ...
    merged = main(ticket_length, ticket, year, model, rabat_level)
